---
name: spring-boot
description: Build or extend Spring Boot applications with a phase-aware workflow. Use when the task involves project setup, controller-service-repository structure, DTO and entity design, persistence, or routine Spring Boot development decisions.
---
...
1. Identify the phase: setup, web, or persistence.
