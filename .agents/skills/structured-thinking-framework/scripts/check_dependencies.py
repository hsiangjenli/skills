#!/usr/bin/env python3
"""
Dependency Check Script for Structured Thinking Framework Skill
...
def install_dependencies():
    ...
    try:
        ...
        subprocess.run(["uv", "sync"], cwd=skill_dir, check=True)
...
def main():
    ...
    if not deps_ok and args.install:
        ...
        print("   uv run scripts/check_dependencies.py --install")
        sys.exit(1)

    print("\n🎉 Ready to use Structured Thinking Framework skill!")
